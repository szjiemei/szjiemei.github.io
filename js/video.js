jQuery(document).ready(function ($) {
	...
	$('#play-button').on('click', function(e) {
		...
		videoContainer.prepend('<iframe src="//player.vimeo.com/video/92619060" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
